<template>
	<div class="audio-player">
		...
		<div class="play-info">
			...
			<!-- 时间 -->
			<div class="time">
				{{ secondsToMinites(playingData.currentTime) }}/{{ secondsToMinites(playingData.duration) }}
			</div>
		</div>
...
import { ref, Ref, reactive, onMounted, computed, watchEffect } from 'vue'
